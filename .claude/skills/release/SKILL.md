---
name: release
description: 'ALWAYS use this skill when the user wants to publish, release, or version bump the npm package. Covers the complete release workflow: pre-checks, changelog, version bump, npm publish, GitHub release, and verification.'
